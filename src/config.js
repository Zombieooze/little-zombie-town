export const CONFIG = {
  ...
  level: { baseXp: 12 },
  rewards: {},
  boss: { spawnTimes: [300, 600, 900, 1200, 1500], slamCooldownMin: 4, slamCooldownMax: 4, slamWindup: 3, slamImpactTime: 2.55, slamRadius: 4.6, slamConeAngle: Math.PI / 2, slamConeRange: 4.6, slamDamage: 34, slamTriggerRange: 10.5 },

export const CONFIG = {
  ...
  zombie: {
    ...
    types: {
      ...
      boss: { name: 'Gravebreaker', health: 560, speed: 1.79, damage: 24, radius: 1.75, xp: 420, coins: 32, scale: 2.15, weight: 0, unlockTime: 9999, unlockLevel: 999, medkitChance: 0.75, skin: 0x4d8d39, shirt: 0x25222c },
    },
  },
  ...
  boss: { spawnTimes: [240, 480], slamCooldownMin: 8, slamCooldownMax: 12, slamWindup: 3, slamImpactTime: 2.55, slamRadius: 4.6, slamDamage: 38, slamTriggerRange: 10.5 },

...
- The arena is **130 x 130** with one clear central road crossing/intersection and four compact themed corners: Residential, Gas / convenience store, Old Fountain Park, and an abandoned Motel zone.
...
- Active major blockers are intentionally limited to solid buildings, burnt vehicles, the solid motel, and larger park trees. Light rubble patches, road cracks/markings, sidewalks, parking lines, pumps, and small ground debris are decorative or minimally intrusive.

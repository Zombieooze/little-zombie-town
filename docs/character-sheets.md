...
The Boss Zombie has been remodeled as **Gravebreaker**, a giant named monster boss built from the same lightweight procedural low-poly shapes as the other enemies. Gravebreaker has green skin, a huge square head, angry red eyes, an open mouth with chunky teeth, a massive dark armored torso with a skull plate, oversized arms, huge fists, shoulder armor with spikes/studs, dark pants, and dark boots. It is intended to read as the largest zombie in the game and visually distinct from the Crusher rather than a simple scaled-up heavy enemy. For this remodel pass, Gravebreaker keeps the existing Boss Zombie gameplay role, spawn behavior, health, speed, damage, XP, and coin rewards unchanged. Future boss mechanics are planned separately: timed 4:00/8:00 spawns, a top boss health bar, a warning message, and a wind-up ground-slam attack with a visible radius warning.
